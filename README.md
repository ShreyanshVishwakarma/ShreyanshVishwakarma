...
![Typing SVG](https://readme-typing-svg.herokuapp.com?font=Fira+Code&weight=600&size=25&pause=1000&color=3F7EF7&center=true&vCenter=true&width=600&lines=Full-Stack+Developer;Blockchain+Lead+%40+GDG+IIIT+Surat;Rust+%26+TypeScript+Enthusiast;Building+Real-Time+Applications;Grand+Finalist+UDBHAV+Hackathon)
...
[![Portfolio](https://img.shields.io/badge/Portfolio-000000?style=for-the-badge&logo=vercel&logoColor=white)](https://shreyansh.is-a.dev)
...
Building real-time web applications with modern tech stack including Next.js, TypeScript, Node.js, Express.js, and MongoDB. Specializing in end-to-end encrypted messaging systems and authentication solutions.
...
<tr>
  ...
  <td align="center"><img src="https://img.shields.io/badge/Solidity-363636?style=for-the-badge&logo=solidity&logoColor=white" /><br><strong>Solidity</strong></td>
...
<tr>
  ...
  <td align="center"><img src="https://img.shields.io/badge/Convex-FF6B35?style=for-the-badge&logo=convex&logoColor=white" /><br><strong>Convex</strong></td>
</tr>
<tr>
  ...
  <td align="center"><img src="https://img.shields.io/badge/BetterAuth-4A5568?style=for-the-badge&logo=auth0&logoColor=white" /><br><strong>BetterAuth</strong></td>
  <td align="center"><img src="https://img.shields.io/badge/Clerk-6C47FF?style=for-the-badge&logo=clerk&logoColor=white" /><br><strong>Clerk</strong></td>
  <td align="center"><img src="https://img.shields.io/badge/bcrypt-338?style=for-the-badge&logo=letsencrypt&logoColor=white" /><br><strong>bcrypt</strong></td>
</tr>
</table>
...
<table>
<tr>
  <td align="center"><img src="https://img.shields.io/badge/Ethereum-3C3C3D?style=for-the-badge&logo=ethereum&logoColor=white" /><br><strong>Ethereum</strong></td>
  <td align="center"><img src="https://img.shields.io/badge/Solidity-363636?style=for-the-badge&logo=solidity&logoColor=white" /><br><strong>Smart Contracts</strong></td>
  <td align="center"><img src="https://img.shields.io/badge/Web3-F16822?style=for-the-badge&logo=web3.js&logoColor=white" /><br><strong>Web3</strong></td>
</tr>
</table>
...
### ⛓️ [LandTrust](https://github.com/ShreyanshVishwakarma/LandTrust)
...
- **Ethereum smart contracts** for secure property transactions
- **Decentralized ownership** verification system
- **Immutable land record** management
- **Grand Finalist** at UDBHAV National Hackathon by IIIT Sri City
- Led team through 3 rounds representing IIIT Surat

[📂 Code](https://github.com/ShreyanshVishwakarma/LandTrust)

</td>
<td width="50%">

### 🦀 [RustyML](https://github.com/ShreyanshVishwakarma/RustyML)
...
- **ML algorithms from scratch** without external ML libraries
- **Linear & logistic regression** implementations
- **Neural networks** built in Rust
- **Memory-safe** implementations
- **Performance optimization** in systems programming

[📂 Code](https://github.com/ShreyanshVishwakarma/RustyML)
...
### 🔐 [CTF Platform](https://github.com/ShreyanshVishwakarma/ctf-platform)
**Jeopardy-Style Cybersecurity Competition**

![Next.js](https://img.shields.io/badge/Next.js-000000?style=flat-square&logo=next.js&logoColor=white)
![Convex](https://img.shields.io/badge/Convex-FF6B35?style=flat-square&logo=convex&logoColor=white)
![TypeScript](https://img.shields.io/badge/TypeScript-007ACC?style=flat-square&logo=typescript&logoColor=white)

- **National-level CTF** competition platform
- **Real-time leaderboard** with live updates
- **User registration** and flag validation
...
### 🌐 [Portfolio Website](https://shreyansh.is-a.dev)
...
- Deployed at **shreyansh.is-a.dev**

[🔗 Live Demo](https://shreyansh.is-a.dev)
...
### 📚 [Book Store API](https://github.com/ShreyanshVishwakarma/Book-store-API)
...
### 🦀 [RustyTodo](https://github.com/ShreyanshVishwakarma/rustytodo)
...
- 🥈 **Grand Finalist at UDBHAV National Hackathon** - Led team representing IIIT Surat through 3 rounds (intra-college, inter-IIIT, national finals with 21 IIITs), working on LandTrust blockchain project
- 🎯 **Organized National-Level CTF Event** - Created and hosted Jeopardy-style cybersecurity competition as GDG Blockchain Lead with participants from across India
- 🥈 **2nd Rank in College Competitive Programming Competition**
- 🏅 **Winner - ScriptSorcery Reimagine** - Frontend development competition

---

## 👔 Position of Responsibility

**Blockchain Lead** | Google Developer Group (GDG), IIIT Surat `2025 - Present`
- Leading blockchain initiatives and organizing technical workshops for GDG community
- Organized a national-level Jeopardy-style CTF cybersecurity competition with participants from across India
- Developed complete CTF platform using Next.js and Convex with real-time leaderboard
- Created all CTF challenges and questions, managing the entire technical infrastructure
...
- **Build** production-scale dApps
- **Explore** WebAssembly & Rust integration
...
I'm a passionate **Full-Stack Developer** and **Blockchain Lead at GDG IIIT Surat**, building innovative web applications and exploring cutting-edge technologies. My journey spans from **systems programming with Rust** to **blockchain development with Solidity** and **modern web development with TypeScript and React**.

- 🔭 Currently working on **real-time applications** and **blockchain projects**
- 🌱 Learning **advanced backend architectures**, **smart contract development**, and **cloud technologies**
- 💡 Interested in **WebAssembly**, **distributed systems**, and **performance optimization**
- 🎯 Contributing to **open-source projects** and building **scalable applications**
- ⚡ Love **competitive programming** and organizing **technical events**
