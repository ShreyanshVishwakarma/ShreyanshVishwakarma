...
- **Freelance Full-Stack Developer (2023–Present):** Built and deployed 3+ full-stack apps with 99% uptime; integrated real-time chat/notifications and secure auth flows.
- **Frontend Intern, Raise Digital (Aug 2024 – Sep 2024):** Engineered responsive React components and reduced rendering inconsistencies across devices.
- **Blockchain Lead, GDG IIIT Surat (2025–Present):** Conducted workshops for 200+ members and led a national-level CTF event with 100+ participants.

## Technical Stack

TypeScript, JavaScript, Python, Rust, Solidity, C, SQL, Next.js, React, Node.js, Express, Convex, Socket.io, MongoDB, PostgreSQL, Redis, Ethereum, Hardhat, Docker, Linux, AWS, and Vercel.

## Highlights

- Grand Finalist — UDBHAV National Hackathon (21 IIITs)
- 2nd Rank — College Competitive Programming Contest
- 1st Place — ScriptSorcery Reimagine Frontend Competition
- NCC B Certificate; mentored 200+ developers in GDG community initiatives
